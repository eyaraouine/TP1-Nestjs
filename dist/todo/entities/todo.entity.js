...
const time_stamp_1 = require("../../dates/time-stamp");
let TodoEntity = class TodoEntity extends time_stamp_1.TimeStamp {
};
__decorate([
...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: todos_status_enum_1.TodoStatusEnum, default: "En attente" }),
    __metadata("design:type", String)
